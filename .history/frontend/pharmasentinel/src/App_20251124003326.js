...
// ================================================================
// 🔹 DASHBOARD LAYOUT → Uses Sidebar + Topbar
// ================================================================
...
const GenericDashboardLayout = () => <DashboardLayout><Outlet /></DashboardLayout>;
  ...
  return (
    <Routes>
      ...
      <Route path="dashboard">
        ...
        {/* DRAP */}
        <Route element={<GenericDashboardLayout />}>
          <Route path="drap" element={<DRAPDashboard />} />
          <Route path="register-user" element={<RegisterUser />} />
          <Route path="all-users" element={<AllUsers />} />
        </Route>

        {/* Manufacturer → Sidebar + Topbar layout */}
