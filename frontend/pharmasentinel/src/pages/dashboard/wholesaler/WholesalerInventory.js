...
import { getWholesalerInventory } from "../../../services/api";
  ...
  return (
    <WholesalerLayout>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="mb-1">📦 Wholesaler Inventory</h2>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              (window.location.href = `/dashboard/wholesaler/transfer?batch=${item.batch_id}`)
                            }
