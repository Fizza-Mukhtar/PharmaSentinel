...
export default function WholesalerVerifyBatch() {
  ...
  return (
    <WholesalerLayout>
      <div className="mb-4">
        ...
        <p className="text-muted mb-0">Verify authenticity and integrity of medicine batches</p>
      </div>

      {error && (
        <Alert variant="danger" dismissible onClose={() => setError(null)} className="border-0 shadow-sm">
          <div className="d-flex align-items-start">
            <FiAlertTriangle className="me-2 mt-1" size={20} />
            <div>
        ...
        <Card.Body className="p-4">
              ...
              <Col md={8}>
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    disabled={loading}
                    style={{ fontFamily: 'monospace', height: '48px', fontSize: '1rem' }}
                  />
                </Form.Group>
              </Col>
          ...
          <div className="mt-3 text-center">
            <small className="text-muted d-flex align-items-center justify-content-center gap-1">
              <FiInfo size={14} />
              You can also scan the QR code on medicine packaging
            </small>
          </div>
        </Card.Body>
      </Card>
            ...
            <Card.Body className="p-4">
              <div className="d-flex align-items-center gap-4">
                ...
                <div className="flex-grow-1">
                  <h4 className="mb-1 fw-bold" style={{ color: getSeverityColor(result) }}>
                ...
                <Row>
                  <Col md={6} className="mb-3">
                    <div className="p-3 border rounded" style={{ backgroundColor: "#f9fafb" }}>
                      ...
                      <div className="fw-bold mt-1" style={{ fontSize: "1.1rem", fontFamily: "monospace", color: "#047857" }}>
                    ...
                    <Col md={12} className="mt-3">
                      <div className="text-center p-3 border rounded" style={{ backgroundColor: "#f9fafb" }}>
                        ...
                        <img 
                          ...
                          alt="Batch QR Code" 
                          style={{ maxWidth: "180px", border: "2px solid #047857", borderRadius: "8px" }}
                        />
                      </div>
                    </Col>
                  )}
            ...
            <Card className="border-0 shadow-sm">
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <Badge bg={result.detailed_info.blockchain.is_valid ? "success" : "danger"}>
                    {result.detailed_info.blockchain.is_valid ? "Valid Chain" : "Invalid Chain"}
                  </Badge>
                </div>
                <Alert variant="info" className="mb-3">
                  <FiInfo className="me-2" />
                  <strong>Chain Length:</strong> {result.detailed_info.blockchain.total_blocks} blocks
                </Alert>
                <div className="position-relative" style={{ paddingLeft: "40px" }}>
        ...
        <Card className="border-0 shadow-sm">
          <Card.Body className="text-center py-5">
            ...
            <p className="text-muted mb-0">
              Enter a batch ID above to verify blockchain integrity
            </p>
          </Card.Body>
        </Card>
      )}
