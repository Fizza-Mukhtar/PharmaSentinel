// src/pages/wholesaler/WholesalerDashboard.js
    ...
    <WholesalerLayout>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted mb-0">Monitor your Wholesaler inventory and operations</p>
        </div>
        <div className="d-flex gap-2">
          <Button
                      variant="primary"
                      onClick={() =>
                        handleExport(exportWholesalerInventoryCSV, "Inventory Report")
                      }
      ...
      <Row className="mb-4">
        {[
          { icon: "📥", label: "Incoming Batches", path: "/wholesaler/incoming", color: "#f59e0b" },
          { icon: "📦", label: "Manage Inventory", path: "/wholesaler/inventory", color: "#10b981" },
          { icon: "🔄", label: "Transfer Batch", path: "/wholesaler/transfer", color: "#3b82f6" },
          { icon: "🛡️", label: "Verify Blockchain", path: "/wholesaler/verify", color: "#06b6d4" },
        ].map((action, idx) => (
          <Col md={3} key={idx}>
            <Card 
