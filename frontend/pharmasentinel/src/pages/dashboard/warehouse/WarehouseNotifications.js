...
export default function WarehouseNotifications() {
  ...
  const loadNotifications = async () => {
    ...
    setError(null);
    try {
      const data = await getWarehouseNotifications();
                ...
                <ListGroup.Item 
                  ...
                  onClick={() => {
                    if (notification.batch_id) {
                      window.location.href = `/warehouse/verify?batch=${notification.batch_id}`;
                    }
                  }}
                >
        ...
        <Card.Body>
          ...
          <div className="row">
            <div className="col-md-6">
              <p className="mb-2">
                <Badge bg="primary">INCOMING TRANSFER</Badge> - New batch received from distributor
              </p>
              <p className="mb-2">
                <Badge bg="success">OUTGOING TRANSFER</Badge> - Batch transferred to wholesaler
              </p>
              <p className="mb-2">
