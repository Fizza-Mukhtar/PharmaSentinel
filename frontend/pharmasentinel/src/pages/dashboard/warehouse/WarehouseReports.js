// src/pages/warehouse/WarehouseReports.js - COMPLETE FIXED VERSION
...
import { 
  ...
  exportWarehouseIncomingCSV,
  exportWarehouseOutgoingCSV,
  exportWarehouseExpiredCSV,
} from "../../../services/api";
...
export default function WarehouseReports() {
  ...
  const loadStats = async () => {
    try {
      ...
      setError("Failed to load warehouse statistics");
    }
  };
    ...
    <WarehouseLayout>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted mb-0">Generate and download warehouse reports</p>
        </div>
      </div>
      ...
      <Card className="border-0 shadow-sm mb-4">
        <Card.Body>
          <h5 className="mb-3">📊 Warehouse Statistics</h5>
          <Row>
            ...
            <Card.Body>
              <div className="d-flex align-items-start mb-3">
                ...
                <div>
                  ...
                  <small className="text-muted">Complete list of all batches in warehouse</small>
                </div>
              </div>
              ...
              <div className="d-flex gap-2">
                <Button 
                  variant="primary" 
                  onClick={() => handleExport(exportWarehouseInventoryCSV, "Inventory Report")}
            ...
            <Card.Body>
              <div className="d-flex align-items-start mb-3">
                ...
                <div>
                  ...
                  <small className="text-muted">All received batches from distributors</small>
                </div>
              </div>
              <ul className="report-details">
              ...
              <div className="d-flex gap-2">
                <Button 
                  variant="success"
                  onClick={() => handleExport(exportWarehouseIncomingCSV, "Incoming Stock Report")}
                  disabled={exportingReport !== null}
                  className="flex-grow-1"
                >
            ...
            <Card.Body>
              <div className="d-flex align-items-start mb-3">
                ...
                <div>
                  ...
                  <small className="text-muted">All batches transferred to wholesalers</small>
                </div>
              </div>
              <ul className="report-details">
                <li>Transfer Date & Time</li>
                <li>Batch & Wholesaler Details</li>
              ...
              <div className="d-flex gap-2">
                <Button 
                  variant="warning"
                  onClick={() => handleExport(exportWarehouseOutgoingCSV, "Outgoing Transfers Report")}
                  disabled={exportingReport !== null}
                  className="flex-grow-1"
                >
          ...
          <Card className="border-0 shadow-sm h-100">
            <Card.Body>
              ...
              <div className="d-flex gap-2">
                <Button 
                  variant="danger"
                  onClick={() => handleExport(exportWarehouseExpiredCSV, "Expired Medicines Report")}
                  disabled={exportingReport !== null}
                  className="flex-grow-1"
                >
