// src/pages/warehouse/IncomingBatches.js
import React, { useState, useEffect } from "react";
import { Card, Button, Badge, Alert, Modal, Form  , Spinner} from "react-bootstrap";
import WarehouseLayout from "../../../components/warehouse/WarehouseLayout";
import { getIncomingBatches, confirmReceiveBatch , rejectBatch } from "../../../services/api";
...
export default function IncomingBatches() {
  ...
  const confirmAccept = async () => {
    ...
    setSuccess(null);
    try {
      await confirmReceiveBatch(selectedBatch.transfer_id);
    ...
    <WarehouseLayout>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted mb-0">Review and accept batches from distributors</p>
        </div>
